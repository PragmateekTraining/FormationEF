...
namespace ADONET.Tests {
    ...
    public partial class LogsDataSet : global::System.Data.DataSet {
        ...
        public partial class LogsDataTable : global::System.Data.TypedTableBase<LogsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public LogsRow AddLogsRow(System.DateTime Timestamp, string Level, string Message) {
...
namespace ADONET.Tests.LogsDataSetTableAdapters {
    ...
    public partial class LogsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Logs] WHERE (([ID] = @Original_ID) AND ((@IsNull_Timestamp = 1" +
                " AND [Timestamp] IS NULL) OR ([Timestamp] = @Original_Timestamp)) AND ((@IsNull_" +
                "Level = 1 AND [Level] IS NULL) OR ([Level] = @Original_Level)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Logs] ([Timestamp], [Level], [Message]) VALUES (@Timestamp, @L" +
                "evel, @Message);\r\nSELECT ID, Timestamp, Level, Message FROM Logs WHERE (ID = SCO" +
                "PE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Logs] SET [Timestamp] = @Timestamp, [Level] = @Level, [Message] = @Message WHERE (([ID] = @Original_ID) AND ((@IsNull_Timestamp = 1 AND [Timestamp] IS NULL) OR ([Timestamp] = @Original_Timestamp)) AND ((@IsNull_Level = 1 AND [Level] IS NULL) OR ([Level] = @Original_Level)));
SELECT ID, Timestamp, Level, Message FROM Logs WHERE (ID = @ID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::ADONET.Tests.Properties.Settings.Default.ADONET_TestsConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, Timestamp, [Level], Message FROM dbo.Logs";
        ...
        public virtual int Delete(long Original_ID, global::System.Nullable<global::System.DateTime> Original_Timestamp, string Original_Level) {
        ...
        public virtual int Insert(global::System.Nullable<global::System.DateTime> Timestamp, string Level, string Message) {
        ...
        public virtual int Update(global::System.Nullable<global::System.DateTime> Timestamp, string Level, string Message, long Original_ID, global::System.Nullable<global::System.DateTime> Original_Timestamp, string Original_Level, long ID) {
            if ((Timestamp.HasValue == true)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(global::System.Nullable<global::System.DateTime> Timestamp, string Level, string Message, long Original_ID, global::System.Nullable<global::System.DateTime> Original_Timestamp, string Original_Level) {
            return this.Update(Timestamp, Level, Message, Original_ID, Original_Timestamp, Original_Level, Original_ID);
        }
    }
